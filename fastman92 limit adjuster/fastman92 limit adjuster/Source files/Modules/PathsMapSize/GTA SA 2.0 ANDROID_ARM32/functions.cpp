// Compilation time: 19 seconds 571 ms
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CAutoPilot__ModifySpeed_2E3550()
{
	...
	".thumb\n"
		"PUSH {R0, R1}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_pPathNodes)
		"LDR R2, [R2,R0]\n"
		"POP {R0, R1}\n"
		"CMP R2, #0\n"
		"BEQ 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__GenerateCarCreationCoors2_2E7942()
{
	...
	".thumb\n"
		"PUSH {R1, R2}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_pPathNodes)
		"LDR R0, [R0,R1]\n"
		"POP {R1, R2}\n"
		"CMP R0, #0\n"
		"BEQ 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__GenerateCarCreationCoors2_2E796C()
{
	...
	".thumb\n"
		"PUSH {R0, R1}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_pNaviLinks)
		"LDR R3, [R3,R0]\n"
		"POP {R0, R1}\n"
		"LDR R2, [R3,R2,LSL#2]\n"
		"LSRS R3, R2, #16\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__GenerateCarCreationCoors2_2E7992()
{
	...
	".thumb\n"
		...
		"PUSH {R0, R1}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_pNaviNodes)
		"LDR R3, [R3,R0]\n"
		"POP {R0, R1}\n"
		"ADD R2, R3, R6,LSL#1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__GenerateCarCreationCoors2_2E7C44()
{
	...
	".thumb\n"
		...
		"PUSH {R1, R2}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_pNodeLinks)
		"LDR R0, [R0,R1]\n"
		"POP {R1, R2}\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__GenerateCarCreationCoors2_2E8094()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_pPathNodes)
		"LDR R3, [R0,R3]\n"
		"MOV R0, R1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__GenerateCarCreationCoors2_2E8172()
{
	...
	".thumb\n"
		"PUSH {R0, R1}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_pNodeLinks)
		"LDR R3, [R3,R0]\n"
		"POP {R0, R1}\n"
		"ADD R1, R3, R1,LSL#2\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__GenerateOneRandomCar_2E897C()
{
	...
	".thumb\n"
		"MOVS R0, #0\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R5, Offset_CPathFind__m_pNodeLinks)
		"LDR R5, [R1,R5]\n"
		"MOVS R1, #0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__PickNextNodeRandomly_2EA9E8()
{
	...
	".thumb\n"
		"BFC R1, #16, #16\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_pNaviNodes)
		"LDR R2, [R0,R2]\n"
		"MOV R12, R1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__JoinCarWithRoadSystem_2EC0E6()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_pNodeLinks)
		"LDR R2, [R0,R2]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__JoinCarWithRoadSystem_2EC0FC()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R12, Offset_CPathFind__m_pPathNodes)
		"LDR R12, [R0,R12]\n"
		"CMP R12, #0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__PickNextNodeToChaseCar_2EFE58()
{
	...
	".thumb\n"
		"PUSH {R1, R2}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_pNaviLinks)
		"LDR R0, [R0,R1]\n"
		"POP {R1, R2}\n"
		"LDR R2, [R0,R2,LSL#2]\n"
		"PUSH {R0-R3,R12,LR}\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__PickNextNodeToChaseCar_2EFEE6()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R5, Offset_CPathFind__m_pNaviNodes)
		"LDR R5, [R0,R5]\n"
		"MOV R0, R2\n"
		ASM_MUL_4BYTE_VALUE_STORED_ON_SYMBOL(R0, SizeOfCCarPathLinkDividedBy2)
		"ADD R0, R5, R0,LSL#1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__PickNextNodeToFollowPath_2F0220()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, Offset_CPathFind__m_pNaviNodes)
		"LDR R6, [R0,R6]\n"
		"MOV R0, R5\n"
		ASM_MUL_4BYTE_VALUE_STORED_ON_SYMBOL(R0, SizeOfCCarPathLinkDividedBy2)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__IsThisAnAppropriateNode_2F0736()
{
	...
	".thumb\n"
		"MOV R2, R6\n"
		ASM_MUL_4BYTE_VALUE_STORED_ON_SYMBOL(R2, SizeOfCPathNodeDividedBy4)
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R5, Offset_CPathFind__m_pPathNodes)
		"LDR R5, [R1,R5]\n"
		"ADD R6, R0, R2,LSL#2\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__FindPathDirection_2F0CD2()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(LR, Offset_CPathFind__m_pPathNodes)
		"LDR LR, [R6,LR]\n"
		"CMP LR, #0\n"
		"BEQ 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__FindLinksToGoWithTheseNodes_2FAE3C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_pNodeLinks)
		"LDR R3, [R2,R3]\n"
		"PUSH {R0, R2}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_pPathNodes)
		"LDR R1, [R1,R0]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__FindNodesThisCarIsNearestTo_2FBB64()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, iNumberOfPathFilesPerDimensionMinusOne)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__FindNodesThisCarIsNearestTo_2FBC40()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R5, Offset_CPathFind__m_dwNumVehicleNodes)
		"ADD R2, R2, R4,LSL#2\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__Init_315256()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_bForbiddenForScriptedCarsEnabled)
		"STRB R1, [R0,R2]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_dwNumForbiddenAreas)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__Init_31526C()
{
	...
	".thumb\n"
		...
		"POP {R0, R2}\n"
		"PUSH {R0, R2}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_pLinkLengths)
		"STR R1, [R3,R0]\n"
		"POP {R0, R2}\n"
		"PUSH {R0, R2}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_pPathIntersections)
		"STR R1, [R3,R0]\n"
		"POP {R0, R2}\n"
		"PUSH {R0, R2}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_pNaviLinks)
		...
		"POP {R0, R2}\n"
		"PUSH {R0, R2}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_field_EA4)
		"STR R1, [R3,R0]\n"
		"POP {R0, R2}\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__Init_31528A()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_interiorAreaIDarray_index_7)
		"MOV R2, #0xFFFF\n"
		"MOVT R2, #0xFFFF\n"
		"STR R2, [R0,R1]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_interiorAreaIDarray_index_6)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__Init_31529A()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_interiorAreaIDarray_index_5)
		"STR R2, [R0,R1]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_interiorAreaIDarray_index_4)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__Init_3152A6()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_interiorAreaIDarray_index_3)
		"STR R2, [R0,R1]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_interiorAreaIDarray_index_2)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__Init_3152B2()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_interiorAreaIDarray_index_1)
		"STR R2, [R0,R1]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_interiorAreaIDarray_index_0)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__ReInit_3152C4()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_dwNumForbiddenAreas)
		"MOVS R2, #0\n"
		"STR R2, [R0,R1]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_bForbiddenForScriptedCarsEnabled)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__LoadPathFindData_31536A()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_dwNumVehicleNodes)
		"ADD R1, R11, R0\n"
		"MOV R0, R6\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__LoadPathFindData_31537A()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_dwNumPedNodes)
		"ADD R1, R11, R0\n"
		"MOV R0, R6\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__LoadPathFindData_31538A()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_dwNumCarPathLinks)
		"ADD R4, R11, R0\n"
		"MOV R0, R6\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__LoadPathFindData_31539C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_dwNumAddresses)
		"ADD R5, R11, R0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__LoadPathFindData_3153AE()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_dwNumNodes)
		"LDR R0, [R11,R0]\n"
		"CBZ R0, 1f\n"
		ASM_MUL_4BYTE_VALUE_STORED_ON_SYMBOL(R0, SizeOfCPathNodeDividedBy4)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__LoadPathFindData_315432()
{
	...
	".thumb\n"
		"PUSH {R1, R2}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_pLinkLengths)
		"STR R0, [R11,R1]\n"
		"POP {R1, R2}\n"
		"LDR R0, [R5]\n"
		"ADDS R0, #0xC0\n"
		"BL 1f\n"
		"PUSH {R1, R2}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_pPathIntersections)
		"STR R0, [R11,R1]\n"
		"POP {R1, R2}\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__LoadPathFindData_315544()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_1024)
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_field_1544)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__LoadPathFindData_31555C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_1036)
		"ADD R1, R0\n"
		"VST1.32 {D16-D17}, [R2]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__LoadPathFindData_31556A()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_8)
		"ADD R1, R0\n"
		"VST1.32 {D16-D17}, [R1]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_1032)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__LoadPathFindData_31557E()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_12)
		"ADD R0, R1\n"
		"VST1.32 {D16-D17}, [R0]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__SwitchRoadsOffInAreaForOneRegion_3155A8()
{
	...
	".thumb\n"
		...
		"CMP R0, #0\n"
		"BEQ 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, Offset_CPathFind__m_dwNumVehicleNodes)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__DoPathSearch_315A3C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_pNaviLinks)
		"LDR R2, [R0,R2]\n"
		"MOV R6, R4\n"
		"LDR R2, [R2,R8,LSL#2]\n"
		"LSRS R4, R2, #16\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__DoPathSearch_315A4C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, Offset_CPathFind__m_pPathNodes)
		"LDR R6, [R4,R6]\n"
		"CBZ R6, 1f\n"
		"BFC R2, #16, #16\n"
		"PUSH {R0, R1}\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__DoPathSearch_315ABE()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_pLinkLengths)
		"LDR R3, [R0,R3]\n"
		"MOV R0, R5\n"
		"LDRSH R2, [R10,#0xE]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeClosestToCoors_315D80()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R11, iNumberOfPathFilesPerDimensionMinusOne)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeClosestToCoors_315DA0()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R5, iNumberOfPathFilesPerDimensionMinusOne)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeClosestToCoors_315E76()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, iNumberOfPathFilesPerDimensionNegated)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeClosestToCoors_315E86()
{
	...
	".thumb\n"
		...
		"SUB R5, R2, R0\n"
		"POP {R0, R3}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, iNumberOfPathFilesPerDimensionTimes2Plus1Negated)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeClosestToCoors_315E9E()
{
	...
	".thumb\n"
		...
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, iNumberOfPathFilesPerDimensionTimes2Negated)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeClosestToCoors_315EB2()
{
	...
	".thumb\n"
		...
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, iNumberOfPathFilesPerDimensionTimes2Plus2Negated)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeClosestToCoors_316080()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, iTotalNumberOfPathFiles)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeClosestToCoors_3160C0()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, iTotalNumberOfPathFiles_plus_65)
		"STRD R0, R9, [SP,#0xC]\n"
		"MOVS R0, #0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeClosestToCoors_3160F0()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, iTotalNumberOfPathFiles_plus_66)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeClosestToCoors_316110()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, iTotalNumberOfPathFiles_plus_67)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeClosestToCoors_31613A()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, iTotalNumberOfPathFiles_plus_68)
		"STRD R10, R5, [SP]\n"
		"MOV R3, R4\n"
		"STRD R9, R11, [SP,#8]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeClosestToCoors_316164()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, iTotalNumberOfPathFiles_plus_69)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeClosestToCoors_316196()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, iTotalNumberOfPathFiles_plus_70)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeClosestToCoors_3161BA()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, iTotalNumberOfPathFiles_plus_71)
		"LDR R0, [R7,#"/* arg_10 */"0x18]\n"
		"MOV R3, R4\n"
		"STRD R0, R8, [SP,#0x14]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__AddNodeToList_316208()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_dwTotalNumNodesInSearchList)
		"LDR R2, [R0,R1]\n"
		"ADDS R2, #1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__RemoveBadStartNode_316250()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R8, Offset_CPathFind__m_pPathNodes)
		"LDR R8, [R4,R8]\n"
		"CMP R8, #0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__CountFloodFillGroups_316306()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(LR, Offset_CPathFind__m_dwNumVehicleNodes)
		"MOV.W R12, #0x28\n"
		"MOVS R4, #0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__CheckGrid_316484()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R12, Offset_CPathFind__m_dwNumVehicleNodes)
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(LR, Offset_CPathFind__m_dwNumPedNodes)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNextNodeWandering_3165C6()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R9, Offset_CPathFind__m_pPathNodes)
		"LDR R9, [R0,R9]\n"
		"CMP R9, #0\n"
		"BEQ 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__GeneratePedCreationCoors_316934()
{
	...
	".thumb\n"
		...
		"ORR R0, R2, R3\n"
		"POP {R3, R4}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_dwNumVehicleNodes)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__GeneratePedCreationCoors_31694A()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_dwNumPedNodes)
		"MOV R11, R0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__GeneratePedCreationCoors_316A66()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, iTotalNumberOfPathFilesNegatedCNodeAddressMask)
		"ANDS R0, R1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__GeneratePedCreationCoors_Interior_316E98()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, iNumberOfPathFilesPerDimensionMinusOne)
		"VMOV.F32 S20, #0.125\n"
		"VLDR S22, 101f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__GeneratePedCreationCoors_Interior_316FBE()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, iTotalNumberOfPathFilesNegatedCNodeAddressMask)
		"ANDS R1, R0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__CalcRoadDensity_3171E0()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R10, Offset_CPathFind__m_pPathNodes)
		"LDR R10, [R1,R10]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__CalcRoadDensity_3171EE()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_dwNumVehicleNodes)
		"LDR R9, [R1,R3]\n"
		"CMP R9, #1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__CalcRoadDensity_3172B0()
{
	...
	".thumb\n"
		...
		"LSRS R6, R1, #16\n"
		"ADD R12, R0, R6,LSL#2\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R4, Offset_CPathFind__m_pPathNodes)
		"LDR R4, [R12,R4]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeClosestInRegion_3174B0()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_dwNumVehicleNodes)
		"MOVS R5, #0\n"
		"ADD R2, R1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNthNodeClosestToCoors_3176D2()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R10, Offset_CPathFind__m_dwNumVehicleNodes)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNthNodeClosestToCoors_317728()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathNode_index_1_m_dwFlags)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__Find2NodesForCarCreation_317850()
{
	...
	".thumb\n"
		ASM_ADD_4BYTE_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_pPathNodes)
		"SUBS R3, #1\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, Offset_CPathNode_index_1_m_dwFlags)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeClosestToCoorsFavourDirection_317E94()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R8, Offset_CPathFind__m_dwNumVehicleNodes)
		"VMOV S8, R2\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodePairClosestToCoors_318006()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R11, Offset_CPathFind__m_pPathNodes)
		"LDR R11, [R1,R11]\n"
		"CMP R11, #0\n"
		"BEQ 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeOrientationForCarPlacement_3182BA()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_pPathNodes)
		"LDR R2, [R8,R2]\n"
		"CMP R2, #0\n"
		"BEQ 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__FindNodeOrientationForCarPlacement_3182F6()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, Offset_CPathFind__m_pNaviLinks)
		"LDR R6, [R8,R6]\n"
		"MOVS R4, #0\n"
		"ADD R5, R6, R1,LSL#2\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__SwitchRoadsOffInArea_318520()
{
	...
	".thumb\n"
		...
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_dwNumForbiddenAreas)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__SwitchRoadsOffInArea_318538()
{
	...
	".thumb\n"
		"MOVS R2, #0\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_aForbiddenAreas)
		"MOV R6, #0x35B4\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__SwitchRoadsOffInArea_318602()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_aForbiddenAreas)
		ASM_MUL_4BYTE_VALUE_STORED_ON_SYMBOL(R1, SizeOfCPathNodeDividedBy4)
		"ADD R2, R9\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__UnMarkAllRoadNodesAsDontWander_31899C()
{
	...
	".thumb\n"
		...
		"MOVS R1, #1\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R4, Offset_CPathNode_index_1_m_dwFlags)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__SetLinksBridgeLights_318D22()
{
	...
	".thumb\n"
		"VMOV S6, R1\n"
		"MOV LR, R6,LSL#10\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R12, Offset_CPathFind__m_dwNumCarPathLinks)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__MarkRegionsForCoors_319492()
{
	...
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, iNumberOfPathFilesPerDimensionMinusOne)
		"VADD.F32 S10, S6, S0\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R9, iNumberOfPathFilesPerDimensionMinusOne)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__MarkRegionsForCoors_31952C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R5, iNumberOfPathFilesPerDimensionNegated)
		ASM_MAKE_INSTRUCTION_REG_AND_VALUE_STORED_ON_SYMBOL("CMN", R2, iNumberOfPathFilesPerDimension)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__UpdateStreaming_319754()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R10, iNumberOfPathFilesPerDimensionMinusOne)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__UpdateStreaming_31989C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, iNumberOfPathFilesPerDimensionMinusOne)
		"VLDR S0, [R2]\n"
		"VLDR S2, [R2,#4]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__UpdateStreaming_319940()
{
	...
	".thumb\n"
		ASM_MAKE_INSTRUCTION_REG_AND_VALUE_STORED_ON_SYMBOL("CMN", R2, iNumberOfPathFilesPerDimension)
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R4, iNumberOfPathFilesPerDimensionNegated)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__UpdateStreaming_3199F0()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_bForbiddenForScriptedCarsEnabled)
		"LDRB R0, [R1,R0]\n"
		"CMP R0, #0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__UpdateStreaming_3199FE()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_fForbiddenForScrCarsX1)
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_fForbiddenForScrCarsY2)
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_fForbiddenForScrCarsY1)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__UpdateStreaming_319A1A()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_fForbiddenForScrCarsX2)
		"ADD R1, R3\n"
		"VLDR S8, [R0]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__MakeRequestForNodesToBeLoaded_319BE8()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R12, Offset_CPathFind__m_fForbiddenForScrCarsX1)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__MakeRequestForNodesToBeLoaded_319BF4()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R12, Offset_CPathFind__m_bForbiddenForScriptedCarsEnabled)
		"MOVS R1, #1\n"
		"STRB R1, [R0,R12]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_fForbiddenForScrCarsX2)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__MakeRequestForNodesToBeLoaded_319C04()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_fForbiddenForScrCarsY1)
		"STR R3, [R0,R1]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_fForbiddenForScrCarsY2)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__HaveRequestedNodesBeenLoaded_319C20()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_fForbiddenForScrCarsX1)
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_fForbiddenForScrCarsY2)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__HaveRequestedNodesBeenLoaded_319C38()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_fForbiddenForScrCarsY1)
		"ADD R2, R0\n"
		"VLDR S8, [R1]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__HaveRequestedNodesBeenLoaded_319C52()
{
	...
	".thumb\n"
		...
		"VLDR S6, [R2]\n"
		"VADD.F32 S4, S4, S0\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R12, iNumberOfPathFilesPerDimensionMinusOne)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__HaveRequestedNodesBeenLoaded_319CEA()
{
	...
	".thumb\n"
		...
		"IT GT\n"
		"MOVGT R5, R3\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_pPathNodes_divided_by_sizeOf_CNodeAddress_minus_NumberOfPathFilesPerDimension_minus_2)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__AreNodesLoadedForArea_319D62()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, iNumberOfPathFilesPerDimensionMinusOne)
		"VADD.F32 S4, S4, S0\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R12, iNumberOfPathFilesPerDimensionMinusOne)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__StartNewInterior_31A13C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_interiorAreaIDarray_index_0)
		"ADD R0, R2\n"
		"STRB R1, [R3]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_SetOneAdjacentNodeForThisNode_31A5B8()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, Offset_CPathFind__m_pLinkLengths)
		"LDR R6, [R2,R6]\n"
		"STRB R1, [R6,R3]\n"
		"MOVS R6, #0\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_pPathIntersections)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__CompleteNewInterior_31A684()
{
	...
	".thumb\n"
		ASM_MUL_4BYTE_VALUE_STORED_ON_SYMBOL(R0, SizeOfCPathNodeDividedBy4)
		"ADD R1, R10, R1,LSL#2\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_interiorAreaIDarray_index_0)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__CompleteNewInterior_31AA04()
{
	...
	".thumb\n"
		"PUSH {R2, R3}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_pNodeLinks_index_TotalNumberOfPathFile)
		"STR R0, [R1,R2]\n"
		"POP {R2, R3}\n"
		"MOV R0, R8\n"
		"BL 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__CompleteNewInterior_31AA14()
{
	...
	".thumb\n"
		"PUSH {R2, R3}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_pLinkLengths_index_TotalNumberOfPathFile)
		"STR R0, [R1,R2]\n"
		"POP {R2, R3}\n"
		"MOV R0, R8\n"
		"BL 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__CompleteNewInterior_31AA2A()
{
	...
	".thumb\n"
		"PUSH {R1, R2}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__pPathIntersections_index_TotalNumberOfPathFile)
		"STR R0, [R3,R1]\n"
		"POP {R1, R2}\n"
		"LDR R0, [R2]\n"
		"MOVS R2, #0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__CompleteNewInterior_31AB8C()
{
	...
	".thumb\n"
		"PUSH {R0, R2}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_pNodeLinks_index_TotalNumberOfPathFile)
		"LDR R1, [R1,R0]\n"
		"POP {R0, R2}\n"
		"STRH R9, [R1,R0,LSL#2]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__CompleteNewInterior_31AB9C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, Offset_CPathFind__m_dwNumVehicleNodes_index_TotalNumberOfPathFile)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__CompleteNewInterior_31ABBC()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, Offset_CPathFind__m_dwNumNodes_index_TotalNumberOfPathFile)
		"STR R1, [R3,R6]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, Offset_CPathFind__m_dwNumPedNodes_index_TotalNumberOfPathFile)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__CompleteNewInterior_31ABC8()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_dwNumCarPathLinks_index_TotalNumberOfPathFile)
		"STR R5, [R3,R1]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_dwNumAddresses_index_TotalNumberOfPathFile)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__AddDynamicLinkBetween2Nodes_For1Node_31AD1A()
{
	...
	".thumb\n"
		"MOV R6, R3\n"
		ASM_MUL_4BYTE_VALUE_STORED_ON_SYMBOL(R6, SizeOfCPathNodeDividedBy4)
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_dwNumAddresses)
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R12, Offset_CPathFind__m_pPathNodes)
		"LDR R12, [LR,R12]\n"
		"MOV R10, LR\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__AddDynamicLinkBetween2Nodes_For1Node_31ADBA()
{
	...
	".thumb\n"
		...
		"BHI 1f\n"
		"ADD R0, R0, R9,LSL#6\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__AddDynamicLinkBetween2Nodes_For1Node_31ADD2()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_1)
		"LDR R2, [R0,R1]\n"
		"CMP R2, #0\n"
		"BLT 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_2)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__AddDynamicLinkBetween2Nodes_For1Node_31ADE6()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_3)
		"LDR R2, [R0,R1]\n"
		"CMP R2, #0\n"
		"BLT 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_4)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__AddDynamicLinkBetween2Nodes_For1Node_31ADFA()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_5)
		"LDR R2, [R0,R1]\n"
		"CMP R2, #0\n"
		"BLT 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_6)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__AddDynamicLinkBetween2Nodes_For1Node_31AE0E()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_7)
		"LDR R1, [R0,R1]\n"
		"CMP R1, #0\n"
		"BLT 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_8)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__AddDynamicLinkBetween2Nodes_For1Node_31AE22()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_9)
		"LDR R2, [R0,R1]\n"
		"CMP R2, #0\n"
		"BLT 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_10)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__AddDynamicLinkBetween2Nodes_For1Node_31AE36()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_11)
		"LDR R2, [R0,R1]\n"
		"CMP R2, #0\n"
		"BLT 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_12)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__AddDynamicLinkBetween2Nodes_For1Node_31AE4A()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_13)
		"LDR R2, [R0,R1]\n"
		"CMP R2, #0\n"
		"BLT 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, Offset_CPathFind__m_field_1544_index_14)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__RemoveInterior_31AF8A()
{
	...
	".thumb\n"
		...
		"BEQ 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, Offset_CPathFind__m_dwNumVehicleNodes)
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_dwNumNodes)
		"LDR R3, [R4,R3]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__RemoveInterior_31AFB6()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_field_1544_index_1038)
		"ADD R3, R6\n"
		"STR R3, [SP,#0x78+"/* var_68 */"-0x68]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_field_1544_index_1037)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__RemoveInterior_31AFC8()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_field_1544_index_1036)
		"ADD R3, R6\n"
		"STR R3, [SP,#0x78+"/* var_60 */"-0x60]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_field_1544_index_1035)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__RemoveInterior_31AFD8()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_field_1544_index_1034)
		"ADD R3, R6\n"
		"STR R3, [SP,#0x78+"/* var_58 */"-0x58]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_field_1544_index_1033)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__RemoveInterior_31AFE8()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_field_1544_index_1032)
		"ADD R3, R6\n"
		"STR R3, [SP,#0x78+"/* var_50 */"-0x50]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_field_1544_index_1031)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__RemoveInterior_31AFF8()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_field_1544_index_1030)
		"ADD R3, R6\n"
		"STR R3, [SP,#0x78+"/* var_48 */"-0x48]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_field_1544_index_1029)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__RemoveInterior_31B008()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_field_1544_index_1028)
		"ADD R3, R6\n"
		"STR R3, [SP,#0x78+"/* var_40 */"-0x40]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_field_1544_index_1027)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__RemoveInterior_31B018()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_field_1544_index_1026)
		"ADD R3, R6\n"
		"STR R3, [SP,#0x78+"/* var_38 */"-0x38]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_field_1544_index_1025)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__RemoveInterior_31B028()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_field_1544_index_1024)
		"ADD R3, R6\n"
		"STR R3, [SP,#0x78+"/* var_2C */"-0x2C]\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_dwNumAddresses)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__RemoveInterior_31B0A6()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_pNodeLinks_index_1)
		"LDR R3, [R1,R3]\n"
		"PUSH {R0, R2}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_pNodeLinks)
		"STR R3, [R1,R0]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__RemoveInterior_31B0D4()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, Offset_CPathFind__m_pNodeLinks_index_1)
		"LDR R6, [R1,R6]\n"
		"PUSH {R0, R2}\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_pNodeLinks)
		"STR R6, [R1,R0]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__RemoveInterior_31B2A6()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, Offset_CPathFind__m_field_1544)
		"ADD R1, R3, R1,LSL#2\n"
		"LDR R3, [R1,R6]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__ReturnInteriorNodeIndex_31B33C()
{
	...
	".thumb\n"
		...
		"CMP R3, R1\n"
		"BNE 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, iTotalNumberOfPathFiles)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__ReturnInteriorNodeIndex_31B34A()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_interiorAreaIDarray_index_1)
		"LDR R3, [R0,R3]\n"
		"CMP R3, R1\n"
		"BNE 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, iTotalNumberOfPathFiles_plus_65)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__ReturnInteriorNodeIndex_31B358()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_interiorAreaIDarray_index_2)
		"LDR R3, [R0,R3]\n"
		"CMP R3, R1\n"
		"BNE 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, iTotalNumberOfPathFiles_plus_66)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__ReturnInteriorNodeIndex_31B366()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_interiorAreaIDarray_index_3)
		"LDR R3, [R0,R3]\n"
		"CMP R3, R1\n"
		"BNE 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, iTotalNumberOfPathFiles_plus_67)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__ReturnInteriorNodeIndex_31B374()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_interiorAreaIDarray_index_4)
		"LDR R3, [R0,R3]\n"
		"CMP R3, R1\n"
		"BNE 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, iTotalNumberOfPathFiles_plus_68)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__ReturnInteriorNodeIndex_31B382()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_interiorAreaIDarray_index_5)
		"LDR R3, [R0,R3]\n"
		"CMP R3, R1\n"
		"BNE 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, iTotalNumberOfPathFiles_plus_69)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__ReturnInteriorNodeIndex_31B390()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_interiorAreaIDarray_index_6)
		"LDR R3, [R0,R3]\n"
		"CMP R3, R1\n"
		"BNE 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, iTotalNumberOfPathFiles_plus_70)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__ReturnInteriorNodeIndex_31B39E()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, Offset_CPathFind__m_interiorAreaIDarray_index_7)
		"LDR R0, [R0,R3]\n"
		"CMP R0, R1\n"
		"ITTTT NE\n"
		"MOVNE R0, #0xFFFF\n"
		...
		"ORRNE R0, R1\n"
		"BXNE LR\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, iTotalNumberOfPathFiles_plus_71)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CTrafficLights__ShouldCarStopForLight_36246E()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R9, Offset_CPathFind__m_pNaviNodes)
		"LDR R9, [R1,R9]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CTrafficLights__ShouldCarStopForLight_3627D0()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R8, Offset_CPathFind__m_pNaviNodes)
		"LDR R8, [R1,R8]\n"
		"ADD R10, R8, R9,LSL#1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__Save_48CEE4()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, Offset_CPathFind__m_dwNumForbiddenAreas)
		"MOV R5, R0\n"
		"LDR R0, [R4,R6]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__Save_48CF02()
{
	...
	".thumb\n"
		"ADD R8, R4, R6\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, Offset_CPathFind__m_aForbiddenAreas)
		"ADDS R6, R4, R0\n"
