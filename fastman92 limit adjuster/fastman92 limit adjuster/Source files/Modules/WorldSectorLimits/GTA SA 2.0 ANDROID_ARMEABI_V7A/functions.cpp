// Compilation time: 3 seconds 509 ms
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_sub_1A6138_1A6140()
{
	...
	".thumb\n"
		...
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R4, TotalNumberOfWorldSectorsMultipliedBySizeOfCSector)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_sub_1A61A0_1A61A4()
{
	...
	".thumb\n"
		...
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R4, TotalNumberOfWorldLODsectorsMultipliedBySizeOfLODsector)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_sub_1A61C0_1A6234()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R1, TotalNumberOfWorldSectorsMultipliedBySizeOfCSector)
		"BL 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPlantMgr___ColEntityCache_Update_2CDEAA()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R2, iNumberOfWorldSectorsPerDimensionMinusOne)
		"VCVT.S32.F32 S0, S0\n"
		"LDRH R0, [R0]\n"
		"VCVT.S32.F32 S6, S16\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPlantMgr___ColEntityCache_Update_2CDF68()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R0, iNumberOfWorldSectorsPerDimensionMinusOne)
		ASM_CMP_4BYTE_VALUE_STORED_ON_SYMBOL(R1, iNumberOfWorldSectorsPerDimensionMinusOne)
		"IT LT\n"
		"MOVLT R0, R1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__AddModelsToRequestList_2D0962()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R5, iNumberOfWorldSectorsPerDimensionMinusOne)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__AddLodsToRequestList_2D0BBA()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R9, iNumberOfWorldLODsectorsPerDimensionMinusOne)
		"MOVS R2, #0\n"
		"VLDR S16, [R0]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__DeleteRwObjectsBehindCamera_2D5E18()
{
	...
	".thumb\n"
		...
		"MOV R0, #1\n"
		"BLT 500f\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R10, iNumberOfWorldSectorsPerDimensionMinusOne)
		"500:\n"	// past the IT block
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__DeleteRwObjectsBehindCamera_2D5E56()
{
	...
	".thumb\n"
		...
		"MOV R0, #1\n"
		"BLT 500f\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R8, iNumberOfWorldSectorsPerDimensionMinusOne)
		"500:\n"	// past the IT block
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__DeleteRwObjectsBehindCamera_2D5F5A()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R1, iNumberOfWorldSectorsPerDimensionMinusOne)
		ASM_CMP_4BYTE_VALUE_STORED_ON_SYMBOL(R0, iNumberOfWorldSectorsPerDimensionMinusOne)
		"IT GE\n"
		"MOVGE R0, R1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__DeleteRwObjectsBehindCamera_2D5FFE()
{
	...
	".thumb\n"
		ASM_CMP_4BYTE_VALUE_STORED_ON_SYMBOL(R11, iNumberOfWorldSectorsPerDimensionMinusOne)
		"BLT 500f\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R11, iNumberOfWorldSectorsPerDimensionMinusOne)
		"500:\n"	// past the IT block
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__DeleteRwObjectsBehindCamera_2D633A()
{
	...
	".thumb\n"
		...
		"IT GE\n"
		"MOVGE R6, R1\n"
		"LDRD R8, R11, [SP,#0x60+"/* var_4C */"-0x4C]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCollision__CheckCameraCollisionBuildings_2DE98E()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R3, iNumberOfWorldSectorsPerDimensionMinusOne)
		ASM_CMP_4BYTE_VALUE_STORED_ON_SYMBOL(R0, iNumberOfWorldSectorsPerDimensionMinusOne)
		"IT GE\n"
		"MOVGE R0, R3\n"
		"CMP R1, #0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CCarCtrl__ScanForPedDanger_2EE3C4()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R4, iNumberOfWorldSectorsPerDimensionMinusOne)
		"VCVT.S32.F32 S0, S0\n"
		"LDRH R1, [R5,#0x3DF]\n"
...
extern "C"
{
	uintptr_t Address_GTA_SA_2_00_CPlayerInfo__FindObjectToSteal_40B054_thumb = 0;
}

static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPlayerInfo__FindObjectToSteal_40B04A()
{
	__asm(
	".thumb\n"
		...
		"ADD R2, R1, #0x30\n"
		"CMP R1, #0\n"
		ASM_JUMP_TO_ADDRESS_STORED_ON_SYMBOL(Address_GTA_SA_2_00_CPlayerInfo__FindObjectToSteal_40B054_thumb)
		);
}
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPlayerInfo__FindObjectToSteal_40B0F2()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R9, iNumberOfWorldSectorsPerDimensionMinusOne)
		"VMOV R11, S20\n"
		"MOVS R5, #0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CRenderer__ScanSectorList_4109DC()
{
	...
	".thumb\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R1, iNumberOfWorldSectorsPerDimensionMinusOne)
		"STR R0, [R2,#("/* off_A887CC */"0xA887CC - 0xA887C0)]\n"
		"MOV R0, #0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CRenderer__ScanSectorList_RequestModels_411718()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R6, iNumberOfWorldSectorsPerDimensionMinusOne)
		ASM_CMP_4BYTE_VALUE_STORED_ON_SYMBOL(R3, iNumberOfWorldSectorsPerDimensionMinusOne)
		"MOV R2, #0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CRenderer__ScanSectorList_ListModels_411D60()
{
	...
	".thumb\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R5, iNumberOfWorldSectorsPerDimensionMinusOne)
		"STR R3, [R4,#("/* off_A887CC */"0xA887CC - 0xA887C0)]\n"
		"MOV R3, #0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CWorld__ShutDown_42306E()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R5, iNegativeTotalNumberOfWorldSectors)
		"MOVT R10, #0x8888\n"
		"LDR R0, [R0]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CWorld__CastShadow_42759C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R11, iNumberOfWorldSectorsPerDimension)
		"VCVT.S32.F32 S0, S0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPopulation__TestSafeForRealObject_4CEA6C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R2, iNumberOfWorldSectorsPerDimension)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CVehicle__DoBladeCollision_587CA4()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_SIGNED_VALUE_STORED_ON_SYMBOL(R8, iNumberOfWorldSectorsPerDimension)
		"VCVT.S32.F32 S0, S0\n"
