// Compilation time: 10 seconds 327 ms
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CIplStore__Initialise_280298()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_IPL_COUNT_multiplied_by_sizeof_IplDef)
		"BL 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CIplStore__Initialise_2802A2()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_IPL_COUNT)
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, FILE_TYPE_IPL_COUNT)
		"BL 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CIplStore__Shutdown_280434()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, FILE_TYPE_IPL_BASE_ID_PLUS_ONE_then_multiplied_by_sizeof_CStreamingInfo_plus_ucFlags)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CIplStore__Shutdown_280440()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R8, FILE_TYPE_IPL_BASE_ID_PLUS_ONE)
		"LDR R0, [R0]\n"
		"ADDS R4, R0, R1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CIplStore__SetupRelatedIpls_281536()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_IPL_BASE_ID)
		"ADD R0, R8\n"
		"MOVS R1, #8\n"
		"BL 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CIplStore__RemoveRelatedIpls_28164E()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R8, FILE_TYPE_IPL_BASE_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CIplStore__LoadIpls_281A8C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R9, FILE_TYPE_IPL_BASE_ID_PLUS_ONE)
		"MOV R8, #1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CIplStore__EnsureIplsAreInMemory_281BA0()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, FILE_TYPE_IPL_BASE_ID_PLUS_ONE)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CIplStore__LoadAllRemainingIpls_281F6C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_IPL_BASE_ID_PLUS_ONE)
		"ADDS R6, R5, R0\n"
		"MOVS R1, #0x18\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CIplStore__RequestIplAndIgnore_281FD8()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, FILE_TYPE_IPL_BASE_ID)
		"ADD R0, R1\n"
		"MOVS R1, #8\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__ReInit_2CF934()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R5, FILE_TYPE_DFF_LAST_ID)
		ASM_ADD_ADDRESS_STORED_ON_SYMBOL(R0, Address_GTA_SA_2_00_CStreaming__ReInit_2CF93C)
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, FILE_TYPE_TXD_BASE_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__ReInit_2CFA36()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_COUNT_OF_IDS)
		"ADDS R2, #1\n"
		"CMP R2, R0\n"
		"BNE 1f\n"
		"MOVS R4, #0\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R5, FILE_TYPE_SCM_BASE_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__SetMissionDoesntRequireModel_2CFFB6()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R9, FILE_TYPE_DFF_LAST_ID)
		ASM_ADD_ADDRESS_STORED_ON_SYMBOL(R1, Address_GTA_SA_2_00_CStreaming__SetMissionDoesntRequireModel_2CFFBE)
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R8, FILE_TYPE_TXD_BASE_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__RemoveModel_2D00E8()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_DFF_LAST_ID)
		"CMP R11, R0\n"
		"BGT 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__RemoveModel_2D024C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_TXD_LAST_ID)
		"CMP R11, R0\n"
		"BGT 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_TXD_BASE_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__RemoveModel_2D0262()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_COL_LAST_ID)
		"CMP R11, R0\n"
		"BGT 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_COL_BASE_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__RemoveModel_2D0278()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_IPL_LAST_ID)
		"CMP R11, R0\n"
		"BGT 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_IPL_BASE_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__RemoveModel_2D028E()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_DAT_LAST_ID)
		"CMP R11, R0\n"
		"BGT 1f\n"
		"LDR R0, =("/* ThePaths_ptr */"0x677378 - 0x2D02A4)\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, FILE_TYPE_DAT_BASE_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__RemoveModel_2D02AA()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_IFP_LAST_ID)
		"CMP R11, R0\n"
		"BGT 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_IFP_BASE_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__RemoveModel_2D02C0()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_SCM_BASE_ID)
		"CMP R11, R0\n"
		"BLT 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__RequestModel_2D2AB8()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, FILE_TYPE_IFP_BASE_ID)
		"ADD R0, R1\n"
		"MOVS R1, #8\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__ConvertBufferToObject_2D314C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_DAT_BASE_ID)
		"SUBS R2, R4, R0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__ConvertBufferToObject_2D32D8()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_RRR_BASE_ID)
		"SUBS R1, R4, R0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__ConvertBufferToObject_2D3312()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_RRR_LAST_ID)
		"CMP R4, R0\n"
		"BGT 1f\n"
		ASM_CMP_4BYTE_VALUE_STORED_ON_SYMBOL(R6, FILE_TYPE_IFP_COUNT_MINUS_ONE)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__AreAnimsUsedByRequestedModels_2D3542()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R8, FILE_TYPE_TXD_BASE_ID_multiplied_by_sizeof_CStreamingInfo_minus_one)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__GetNextFileOnCd_2D3B12()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, FILE_TYPE_TXD_BASE_ID_multiplied_by_sizeof_CStreamingInfo_minus_one)
		"CMP R0, R1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__GetNextFileOnCd_2D3B38()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, FILE_TYPE_COL_BASE_ID_multiplied_by_sizeof_CStreamingInfo_minus_one)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__GetNextFileOnCd_2D3B52()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, negated_file_ID_offset_to_array_TxdDef_parent_index)
		"LDRH R0, [R0,R1]\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__GetNextFileOnCd_2D3B64()
{
	...
	".thumb\n"
		"SXTH R0, R0\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, FILE_TYPE_TXD_BASE_ID)
		"ADD R0, R1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__GetNextFileOnCd_2D3B90()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, negated_FILE_TYPE_DAT_LAST_ID_multiplied_by_sizeof_CStreamingInfo_plus_one)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__GetNextFileOnCd_2D3B9A()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, FILE_TYPE_IFP_COUNT_plus_one_then_multiplied_by_sizeof_CStreamingInfo_then_minus_two)
		"CMP R0, R1\n"
		"BHI 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__RequestModelStream_2D407E()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, FILE_TYPE_DFF_LAST_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__RequestModelStream_2D418C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, FILE_TYPE_IFP_BASE_ID_multiplied_by_sizeof_CStreamingInfo_plus_uiLoadFlag)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__RequestModelStream_2D4228()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, FILE_TYPE_DFF_LAST_ID)
		"MOV R12, R4\n"
		"IT EQ\n"
		"MOVEQ R0, #1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__LoadScene_2D4BFC()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, FILE_TYPE_COUNT_OF_IDS)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__ClearFlagForAll_2D504A()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, FILE_TYPE_COUNT_OF_IDS)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__RemoveLeastUsedModel_2D54B4()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, FILE_TYPE_TXD_BASE_ID_multiplied_by_sizeof_CStreamingInfo_minus_one)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__RemoveLeastUsedModel_2D5538()
{
	...
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, negated_FILE_TYPE_DAT_LAST_ID_multiplied_by_sizeof_CStreamingInfo_plus_one)
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, FILE_TYPE_IFP_COUNT_plus_one_then_multiplied_by_sizeof_CStreamingInfo_then_minus_two)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__RemoveLeastUsedModel_2D5586()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, FILE_TYPE_RRR_LAST_ID_multiplied_by_sizeof_CStreamingInfo_then_plus_one)
		"MOV R2, R11\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__RemoveLeastUsedModel_2D5596()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, negated_file_ID_offset_to_array_to_CStreamedScriptInfo_status)
		"ADD R0, R0, R5,LSL#5\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CColStore__Initialise_2E2074()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_COL_COUNT_multiplied_by_sizeof_CCollisionFile)
		"BL 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CColStore__Initialise_2E207E()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R0, FILE_TYPE_COL_COUNT)
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R5, FILE_TYPE_COL_COUNT)
		"BL 1f\n"
		"MOVS R1, #1\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CColStore__LoadCollision_2E2AA2()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R8, FILE_TYPE_COL_BASE_ID_PLUS_ONE)
		"MOVS R6, #0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CColStore__EnsureCollisionIsInMemory_2E2C94()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, FILE_TYPE_COL_BASE_ID_PLUS_ONE)
		"MOV R9, #0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CColStore__RequestCollision_2E2E58()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R9, FILE_TYPE_COL_BASE_ID_PLUS_ONE)
		"MOVS R4, #0\n"
		"LDR R11, [R0]\n"
...
extern "C"
{
	...
	uintptr_t Address_GTA_SA_2_00_CColStore__RemoveAllCollision_2E308C_thumb = 0;
}
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CColStore__RemoveAllCollision_2E3084()
{
	...
	".thumb\n"
		...
		"LDR R0, [R0]\n"
		ASM_JUMP_TO_ADDRESS_STORED_ON_SYMBOL(Address_GTA_SA_2_00_CColStore__RemoveAllCollision_2E308C_thumb)
		);
}
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CPathFind__UpdateStreaming_319B1E()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R10, FILE_TYPE_DAT_BASE_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CVehicleRecording__ShutDown_321C72()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R4, FILE_TYPE_RRR_BASE_ID)
		"MOV R6, #0x1DB\n"
		"MOV R8, #0\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CVehicleRecording__RemoveRecordingFile_3242D0()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R5, FILE_TYPE_RRR_BASE_ID)
		"MOV R4, #0x1DB\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CScriptsForBrains__StartOrRequestNewStreamedScriptBrain_32F868()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, FILE_TYPE_SCM_BASE_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CScriptsForBrains__HasAttractorScriptBrainWithThisNameLoaded_32FCF8()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, FILE_TYPE_SCM_BASE_ID_multiplied_by_sizeof_CStreamingInfo_plus_uiLoadFlag)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CTheScripts__ProcessWaitingForScriptBrainArray_32FED2()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, FILE_TYPE_SCM_BASE_ID)
		"ADD R0, R3\n"
		"ADD R3, R0, R0,LSL#2\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CRunningScript__ProcessCommands2200To2299_339A90()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, FILE_TYPE_SCM_BASE_ID)
		"ADD R0, R1\n"
		"MOVS R1, #4\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CTimeInfo__FindOtherTimeModel_384D52()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R10, FILE_TYPE_DFF_LAST_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CTimeInfo__FindOtherTimeModel_384D7C()
{
	...
	".thumb\n"
		"BLT 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, FILE_TYPE_TXD_BASE_ID)
		"CMP R1, R2\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CModelInfo__ReInit2dEffects_385A2E()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R5, FILE_TYPE_TXD_BASE_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CModelInfo__GetModelInfo_385D58()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R4, FILE_TYPE_DFF_LAST_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CModelInfo__GetModelInfoFromHashKey_385DF0()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(LR, FILE_TYPE_DFF_LAST_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CAnimManager__Shutdown_38DC50()
{
	...
	".thumb\n"
		...
		"PUSH {R11}\n"
		"MOVS R4, #0\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R5, FILE_TYPE_IFP_BASE_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CFileLoader__LoadCollisionFile_3EF4B2()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, FILE_TYPE_DFF_LAST_ID)
		"VLD1.8 {D16-D17}, [R2]\n"
		"ADDS R2, #0xE\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CClothes__RequestMotionGroupAnims_457F92()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, FILE_TYPE_IFP_BASE_ID)
		"ADDS R0, R4, R6\n"
		"MOVS R1, #0x12\n"
		"BL 1f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CColAccel__startCache_46610A()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R2, FILE_TYPE_IPL_COUNT_multiplied_by_sizeof_IplDef)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__Init2_46BAA0()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R5, FILE_TYPE_COUNT_OF_IDS)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__Init2_46BC3C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R3, FILE_TYPE_TXD_COUNT_multiplied_by_sizeof_TxdDef)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__LoadCdDirectory_46C150()
{
	...
	".thumb\n"
		...
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, FILE_TYPE_COL_BASE_ID)
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__LoadCdDirectory_46C1CE()
{
	...
	".thumb\n"
		"BL 1f\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R1, FILE_TYPE_RRR_BASE_ID)
		"B 2f\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CStreaming__Save_487A1C()
{
	__asm(
	".thumb\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R6, FILE_TYPE_COUNT_OF_IDS)
		"MOV R8, #0xFF\n"
...
static TARGET_THUMB NAKED void patch_GTA_SA_2_00_CScriptResourceManager__Load_48B7E6()
{
	...
	".thumb\n"
		...
		"MOVS R5, #0\n"
		ASM_LOAD_4BYTE_UNSIGNED_VALUE_STORED_ON_SYMBOL(R9, FILE_TYPE_IFP_BASE_ID)
